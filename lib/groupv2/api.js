...
/** Search for Groups. */
export async function groupSearch(http, params) {
    return http({
        method: 'POST',
...
/** Create a new group. */
export async function createGroup(http, params) {
    return http({
        method: 'POST',
 ...
 */
export async function editGroup(http, params) {
    return http({
        method: 'POST',
 ...
 */
export async function editClanBanner(http, params) {
    return http({
        method: 'POST',
 ...
 */
export async function editFounderOptions(http, params) {
    return http({
        method: 'POST',
 ...
 * group.
 */
export async function addOptionalConversation(http, params) {
    return http({
        method: 'POST',
 ...
 */
export async function editOptionalConversation(http, params) {
    return http({
        method: 'POST',
 ...
 * time.
 */
export async function banMember(http, params) {
    return http({
        method: 'POST',
...
export async function requestGroupMembership(http, params) {
    return http({
        method: 'POST',
...
export async function approveAllPending(http, params) {
    return http({
        method: 'POST',
...
export async function denyAllPending(http, params) {
    return http({
        method: 'POST',
...
/** Approve all of the pending users for the given group. */
export async function approvePendingForList(http, params) {
    return http({
        method: 'POST',
 ...
 * applied.
 */
export async function approvePending(http, params) {
    return http({
        method: 'POST',
...
export async function denyPendingForList(http, params) {
    return http({
        method: 'POST',
...
export async function individualGroupInvite(http, params) {
    return http({
        method: 'POST',
