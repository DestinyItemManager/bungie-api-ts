 ...
 */
async function joinFireteamThread(http, params) {
    return http({
        method: 'POST',
 ...
 * Returns the new state of the fireteam.
 */
async function leaveFireteamThread(http, params) {
    return http({
        method: 'POST',
 ...
 */
async function kickBanFireteamApplicant(http, params) {
    return http({
        method: 'POST',
 ...
 */
async function approveFireteamThread(http, params) {
    return http({
        method: 'POST',
 ...
 * objects.
 */
async function getRecruitmentThreadSummaries(http, params) {
    return http({
        method: 'POST',
