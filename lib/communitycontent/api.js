...
async function getCommunityLiveStatuses(http, params) {
    return http({
        method: 'GET',
...
async function getCommunityLiveStatusesForClanmates(http, params) {
    return http({
        method: 'GET',
...
async function getCommunityLiveStatusesForFriends(http, params) {
    return http({
        method: 'GET',
...
async function getFeaturedCommunityLiveStatuses(http, params) {
    return http({
        method: 'GET',
...
async function getStreamingStatusForMember(http, params) {
    return http({
        method: 'GET',
