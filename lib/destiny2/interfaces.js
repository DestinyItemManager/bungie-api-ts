...
export const DamageType = { None: 0, Kinetic: 1, Arc: 2, Thermal: 3, Void: 4, Raid: 5 };
...
export const DestinyEnergyType = { Any: 0, Arc: 1, Thermal: 2, Void: 3 };
...
export const DestinyVendorFilter = { None: 0 };
