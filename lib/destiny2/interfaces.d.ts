...
export interface DestinySocialCommendationsComponent {
  ...
  readonly commendationNodePercentagesByHash: {
    [key: number]: number;
  };
...
export interface DestinyCurrenciesComponent {
  ...
  readonly materialRequirementSetStates: {
    [key: number]: DestinyMaterialRequirementSetState;
  };
}
...
export interface DestinyVendorsResponse {
  ...
  readonly itemComponents: {
    [key: number]: DestinyVendorItemComponentSetOfint32;
  };
  /**
   * A "lookup" convenience component that can be used to quickly check if the
   * character has access to items that can be used for purchasing.
