 ...
 * itshappening.gif
 */
export async function transferItem(http, params) {
    return http({
        method: 'POST',
 ...
 */
export async function pullFromPostmaster(http, params) {
    return http({
        method: 'POST',
 ...
 */
export async function equipItem(http, params) {
    return http({
        method: 'POST',
 ...
 */
export async function equipItems(http, params) {
    return http({
        method: 'POST',
...
export async function setItemLockState(http, params) {
    return http({
        method: 'POST',
 ...
 */
export async function insertSocketPlug(http, params) {
    return http({
        method: 'POST',
 ...
 * implementation.
 */
export async function activateTalentNode(http, params) {
    return http({
        method: 'POST',
 ...
 */
export async function reportOffensivePostGameCarnageReportPlayer(http, params) {
    return http({
        method: 'POST',
