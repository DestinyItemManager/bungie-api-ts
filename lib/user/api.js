...
async function getBungieNetUserById(http, params) {
    return http({
        method: 'GET',
...
async function getUserAliases(http, params) {
    return http({
        method: 'GET',
...
async function searchUsers(http, params) {
    return http({
        method: 'GET',
 ...
 */
async function getMembershipDataById(http, params) {
    return http({
        method: 'GET',
 ...
 */
async function getMembershipDataForCurrentUser(http) {
    return http({
        method: 'GET',
...
async function getPartnerships(http, params) {
    return http({
        method: 'GET',
