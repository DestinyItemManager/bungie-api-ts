...
export interface DestinyItemSocketEntryDefinition {
   ...
   */
  readonly randomizedPlugItems: DestinyItemSocketEntryPlugItemRandomizedDefinition[];
  /**
...
export interface DestinyProfileUserInfoCard {
  ...
  /**
   * The list of membership types/Platforms that this Destiny Account can be used on -
   * either its own original platform, or any subservient platforms hooked up to it
   * through Cross Save.
   */
