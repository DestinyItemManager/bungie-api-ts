...
export const enum AwaType {
  ...
  InsertPlugs = 1,
  /** Exchange currency to purchase something from a vendor. */
  BuyItemFromVendor = 2,
  /** Return an item to a vendor that accepts returns. */
  RefundItem = 3,
  /**
   * Dismantle highest value weapons and armor. This group requires permission for a
   * specific item and the resulting token can be used once on that specific item.
   */
  DismantleGroupA = 4,
  /** Dismantle high value weapons and armor. */
  DismantleGroupB = 5,
  /** Dismantle mid value weapons and armor. */
  DismantleGroupC = 6
}
