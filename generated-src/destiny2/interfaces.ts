...
export interface DestinyProgressionDisplayPropertiesDefinition {
  ...
  /** Mapped to DestinyIconDefinition in the manifest. */
...
export interface DestinyIconDefinition {
  ...
  readonly specialBackground: string;
  readonly highResForeground: string;
  /**
   * The unique identifier for this entity. Guaranteed to be unique for the type of
   * entity, but not globally.
   *
...
export interface DestinyInventoryItemDefinition {
   ...
   * Clients should use the isFeaturedItem boolean to decide whether or not to show
   * this as opposed to iconWatermark.
   */
  readonly iconWatermarkFeatured: string;
  /**
  ...
  /**
   * Whether or not this item is currently featured in the game, giving it a special
   * watermark
   */
  readonly isFeaturedItem: boolean;
  /**
   * Whether or not this item is holofoil, which has special icon treatment and in-
   * game appearance.
   */
  readonly isHolofoil: boolean;
  /** Whether or not this item is adept, which has increased stats and/or perks. */
  readonly isAdept: boolean;
  /**
...
export interface DestinyPresentationNodeDefinition {
  ...
  /**
   * Primarily for Guardian Ranks, this property if the contents of this node are
   * tied to the current season. These nodes are shown with a different color for the
   * in-game Guardian Ranks display.
   */
...
export interface DestinyActivityDefinition {
  ...
  /** Mapped to DestinyActivityFamilyDefinition in the manifest. */
  readonly activityFamilyHashes: number[];
  /** Mapped to DestinyTraitDefinition in the manifest. */
  readonly traitHashes: number[];
  readonly requirements: DestinyActivityRequirementsBlock;
  /** Mapped to DestinyActivityDifficultyTierCollectionDefinition in the manifest. */
  readonly difficultyTierCollectionHash?: number;
  /** Mapped to DestinyActivitySelectableSkullCollectionDefinition in the manifest. */
  readonly selectableSkullCollectionHashes: number[];
  /** Mapped to DestinyActivityDifficultyTierCollectionDefinition in the manifest. */
  readonly selectableSkullCollections: DestinyActivitySelectableSkullCollections[];
  /**
...
export interface DestinyActivityFamilyDefinition {
  ...
  /** Mapped to DestinyActivitySkullCategoryDefinition in the manifest. */
  readonly disabledSkullCategoryHashes: number[];
  /** Mapped to DestinyActivitySkullSubcategoryDefinition in the manifest. */
  readonly disabledSkullSubcategoryHashes: number[];
  /** Mapped to DestinyActivitySkullSubcategoryDefinition in the manifest. */
  readonly fixedSkullSubcategoryHashes: number[];
  /**
   * The unique identifier for this entity. Guaranteed to be unique for the type of
   * entity, but not globally.
   *
...
export interface DestinyActivitySkullSubcategoryDefinition {
  readonly displayProperties: DestinyDisplayPropertiesDefinition;
  /** Mapped to DestinyActivitySkullCategoryDefinition in the manifest. */
  readonly parentSkullCategoryHash: number;
  readonly availabilityTierRank: number;
  readonly defaultSkullHashes: number[];
  /**
   * The unique identifier for this entity. Guaranteed to be unique for the type of
   * entity, but not globally.
   *
...
export interface DestinyActivityRequirementsBlock {
  /**
   * If being a fireteam Leader in this activity is gated, this is the gate being
   * checked.
   */
  readonly leaderRequirementLabels: DestinyActivityRequirementLabel[];
  /**
   * If being a fireteam member in this activity is gated, this is the gate being
   * checked.
   */
  readonly fireteamRequirementLabels: DestinyActivityRequirementLabel[];
}
...
export interface DestinyActivityDifficultyTierCollectionDefinition {
  readonly difficultyTiers: DestinyActivityDifficultyTierDefinition[];
  /**
   * The unique identifier for this entity. Guaranteed to be unique for the type of
   * entity, but not globally.
   *
...
export interface DestinyActivityDifficultyTierDefinition {
  readonly displayProperties: DestinyDisplayPropertiesDefinition;
  readonly recommendedActivityLevelOffset: number;
  readonly fixedActivitySkulls: DestinyActivitySkull[];
  readonly tierEnabledUnlockExpression: DestinyUnlockExpressionDefinition;
  readonly tierType: DestinyActivityDifficultyTierType;
  /** Mapped to DestinyTraitDefinition in the manifest. */
  readonly optionalRequiredTrait?: number;
  readonly activityLevel: number;
  readonly tierRank: number;
  readonly minimumFireteamLeaderPower: number;
  readonly maximumFireteamLeaderPower: number;
  readonly scoreTimeLimitMultiplier: number;
  /** Mapped to DestinyActivitySelectableSkullCollectionDefinition in the manifest. */
  readonly selectableSkullCollectionHashes: number[];
  readonly skullSubcategoryOverrides: DestinyActivityDifficultyTierSubcategoryOverride[];
}

export interface DestinyActivitySkull {
  readonly hash: number;
  readonly skullIdentifierHash: number;
  readonly displayProperties: DestinyDisplayPropertiesDefinition;
  readonly skullOptions: DestinyActivitySkullOption[];
  readonly dynamicUse: DestinyActivitySkullDynamicUse;
  readonly modifierPowerContribution: number;
  readonly modifierMultiplierContribution: number;
  /** Mapped to DestinyActivitySelectableSkullExclusionGroupDefinition in the manifest. */
  readonly skullExclusionGroupHash?: number;
  readonly hasUi: boolean;
  readonly displayDescriptionOverrideForNavMode: string;
  readonly activityModifierDisplayCategory: DestinyActivityModifierDisplayCategory;
  readonly activityModifierConnotation: DestinyActivityModifierConnotation;
  readonly displayInNavMode: boolean;
  readonly displayInActivitySelection: boolean;
}

export interface DestinyActivitySkullOption {
  readonly optionHash: number;
...
export const enum DestinyActivityDifficultyId {
  Trivial = 0,
  Easy = 1,
  Normal = 2,
  Challenging = 3,
...
export const enum DestinyActivitySkullDynamicUse {
  Unknown = 0,
  Allowed = 1,
  Disallowed = 2,
  Count = 3
...
export const enum DestinyActivityModifierDisplayCategory {
  None = 0,
  ModeRules = 1,
  SelfBuildcraft = 2,
  EnemyAdjustment = 3,
...
export const enum DestinyActivityModifierConnotation {
  Neutral = 0,
  Positive = 1,
  Negative = 2,
  Affix = 3,
...
export const enum DestinyActivityDifficultyTierType {
  Default = 0,
  Training = 1,
  Count = 2
}
...
export interface DestinyActivitySelectableSkullCollectionDefinition {
  readonly displayProperties: DestinyDisplayPropertiesDefinition;
  /** Mapped to DestinyActivitySkullSubcategoryDefinition in the manifest. */
  readonly skullSubcategoryHashes: number[];
  readonly selectionType: DestinyActivitySelectableSkullCollectionSelectionType;
  readonly selectableActivitySkulls: DestinyActivitySelectableSkull[];
  /**
   * The unique identifier for this entity. Guaranteed to be unique for the type of
   * entity, but not globally.
   *
...
export interface DestinyActivitySelectableSkullCollectionSelectionType {
  ...
  readonly refreshTimeMinutes: number;
  readonly refreshTimeOffsetMinutes: number;
}

export interface DestinyActivitySelectableSkull {
  /** Mapped to DestinyTraitDefinition in the manifest. */
  readonly requiredTraitHash?: number;
  readonly requiredTraitExistence: boolean;
  readonly isEmptySkull: boolean;
  /** Mapped to DestinyActivityLoadoutRestrictionDefinition in the manifest. */
  readonly loadoutRestrictionHash?: number;
  readonly activitySkull: DestinyActivitySkull;
}

export interface DestinyActivityLoadoutRestrictionDefinition {
  readonly restrictedItemFilterHash: number;
  /** Mapped to DestinyEquipmentSlotDefinition in the manifest. */
  readonly restrictedEquipmentSlotHashes: number[];
  /**
   * The unique identifier for this entity. Guaranteed to be unique for the type of
   * entity, but not globally.
   *
...
export interface DestinyActivityDifficultyTierSubcategoryOverride {
  readonly skullSubcategoryHash: number;
  readonly refreshTimeMinutes: number;
  readonly refreshTimeOffsetMinutes: number;
}

export interface DestinyActivitySelectableSkullCollections {
  readonly selectableSkullCollectionHash: number;
  readonly minimumTierRank: number;
  readonly maximumTierRank: number;
}
...
export interface DestinyEquippingBlockDefinition {
   ...
   * set.
   *
   * Mapped to DestinyEquipableItemSetDefinition in the manifest.
   */
...
export interface DestinyItemSetPerkDefinition {
   ...
   * Mapped to DestinySandboxPerkDefinition in the manifest.
   */
  readonly sandboxPerkHash: number;
}
...
export interface DestinyArrangementRegionFilterDefinition {
  ...
  readonly statHash: number;
  readonly arrangementIndexByStatValue: { [key: number]: number };
}
...
export interface DestinySeasonDefinition {
  ...
  /** Mapped to DestinySeasonPassDefinition in the manifest. */
  readonly seasonPassList: DestinySeasonPassReference[];
  /** Mapped to DestinyProgressionDefinition in the manifest. */
...
export interface DestinySeasonPassDefinition {
  ...
  readonly color: DestinyColor;
  readonly images: DestinySeasonPassImages;
  /**
   * The unique identifier for this entity. Guaranteed to be unique for the type of
   * entity, but not globally.
   *
...
export interface DestinySeasonPassReference {
  ...
  readonly seasonPassStartDate?: string;
  /** The Season Pass End Date */
  readonly seasonPassEndDate?: string;
}
...
export interface DestinyProgressionSocketPlugOverride {
  readonly socketTypeHash: number;
  /** Mapped to DestinyInventoryItemDefinition in the manifest. */
  readonly overrideSingleItemHash?: number;
}
...
export interface DestinyProgressionRewardItemSocketOverrideState {
   ...
   * progression, if there is any data for it.
   *
   * Mapped to DestinyStatDefinition in the manifest.
   */
...
export interface DestinyManifest {
   ...
   * large file!)
   */
  readonly jsonWorldContentPaths: { [key: string]: string };
  /**
   * This points to the generated JSON that contains all the Definitions. Each key is
...
export interface DestinyProfileResponse {
   ...
   */
  readonly characterUninstancedItemComponents: { [key: string]: DestinyBaseItemComponentSetOfuint32 };
  /** COMPONENT TYPE: PresentationNodes */
...
export interface DestinyProfileComponent {
  ...
  /**
   * A list of season passes aka reward passes that this profile owns. Unlike
   * versionsOwned, these stay with the profile across Platforms, and thus will be
   * valid.
   *
   * Mapped to DestinySeasonPassDefinition in the manifest.
   */
  readonly seasonPassHashes: number[];
  /**
   ...
   * of each new season to the highest-earned non-advanced rank.
   *
   * Mapped to DestinyGuardianRankDefinition in the manifest.
   */
...
export interface DestinyEventCardDefinition {
  ...
  readonly sealPresentationNodeHash: number;
  /** Mapped to DestinyInventoryItemDefinition in the manifest. */
  readonly eventCardCurrencyList: number[];
  /** Mapped to DestinyInventoryItemDefinition in the manifest. */
  ...
  readonly rewardProgressionHash?: number;
  /** Mapped to DestinyPresentationNodeDefinition in the manifest. */
  readonly weeklyChallengesPresentationNodeHash?: number;
  /**
   * The unique identifier for this entity. Guaranteed to be unique for the type of
   * entity, but not globally.
   *
...
export interface DestinyPlugSetsComponent {
   ...
   * Mapped to DestinyPlugSetDefinition in the manifest.
   */
  readonly plugs: { [key: number]: DestinyItemPlug[] };
}
...
export interface DestinyStringVariablesComponent {
  readonly integerValuesByHash: { [key: number]: number };
}
...
export interface DestinyCharacterProgressionComponent {
   ...
   * Mapped to DestinyInventoryItemDefinition in the manifest.
   */
  readonly uninstancedItemPerks: { [key: number]: DestinyItemPerksComponent };
  /**
...
export interface DestinyMilestoneActivity {
   ...
   * get at the modifier data. Note that, in the DestinyActivityDefinition, you will
...
export interface DestinyMilestoneChallengeActivity {
   ...
   *
   * Note that, in the DestinyActivityDefinition, you will see many more modifiers
   ...
   *
   * We don't have any human readable information for these, but savvy 3rd party app
...
export interface DestinyActivity {
  ...
  readonly visibleRewards: DestinyActivityRewardMapping[];
}
...
export const enum DestinyActivityRewardDisplayMode {
  Aggregate = 0,
  PickFirst = 1,
  Count = 2
}
...
export interface DestinyActivityInteractableReference {
  /** Mapped to DestinyActivityInteractableDefinition in the manifest. */
  readonly activityInteractableHash: number;
  readonly activityInteractableElementIndex: number;
}
...
export interface DestinyItemReusablePlugsComponent {
   ...
   */
  readonly plugs: { [key: number]: DestinyItemPlugBase[] };
}
...
export interface DestinyVendorsResponse {
   ...
   */
  readonly itemComponents: { [key: number]: DestinyVendorItemComponentSetOfint32 };
  /**
   * A "lookup" convenience component that can be used to quickly check if the
   * character has access to items that can be used for purchasing.
   *
...
export interface DestinyVendorResponse {
   ...
   * component types.]
   */
  readonly itemComponents: DestinyVendorItemComponentSetOfint32;
  /**
   * A "lookup" convenience component that can be used to quickly check if the
   * character has access to items that can be used for purchasing.
   *
...
export interface PublicDestinyVendorSaleItemSetComponent {
  readonly saleItems: { [key: number]: DestinyPublicVendorSaleItemComponent };
}
...
export interface DestinyPostGameCarnageReportData {
  ...
  readonly selectedSkullHashes: number[];
...
export interface DestinyPostGameCarnageReportExtendedData {
  ...
  readonly scoreboardValues: { [key: string]: DestinyHistoricalStatsValue };
}
...
/**
 * Lists of items that can be used for a variety of purposes, including featuring
 * them as new gear
 */
...
export interface DestinyFireteamFinderConstantsDefinition {
  ...
  readonly fireteamFinderActivityGraphRootCategoryHashes: number[];
  /** Mapped to DestinyActivityDefinition in the manifest. */
  readonly allFireteamFinderActivityHashes: number[];
  readonly guardianOathDisplayProperties: DestinyDisplayPropertiesDefinition;
  readonly guardianOathTenets: DestinyDisplayPropertiesDefinition[];
  /**
   * The unique identifier for this entity. Guaranteed to be unique for the type of
   * entity, but not globally.
   *
...
export interface DestinyFireteamFinderActivityGraphDefinition {
  ...
  readonly sortMatchmadeActivitiesToFront: boolean;
  readonly enabledOnTreeTypesListEnum: DestinyActivityTreeType[];
  readonly activityTreeChildSortMode: DestinyActivityTreeChildSortMode;
  readonly sortPriority?: number;
  /**
   * The unique identifier for this entity. Guaranteed to be unique for the type of
   * entity, but not globally.
...
export interface DestinyFireteamFinderActivitySetDefinition {
  ...
  /** Mapped to DestinyFireteamFinderOptionDefinition in the manifest. */
  readonly optionHashes: number[];
  /** Mapped to DestinyFireteamFinderLabelDefinition in the manifest. */
  readonly labelHashes: number[];
  /** Mapped to DestinyFireteamFinderActivityGraphDefinition in the manifest. */
  readonly activityGraphHashes: number[];
  /** Mapped to DestinyActivityDefinition in the manifest. */
  readonly activityHashes: number[];
  /**
   * The unique identifier for this entity. Guaranteed to be unique for the type of
   * entity, but not globally.
   *
...
export const enum FireteamFinderCodeOptionType {
  None = 0,
  ApplicationOnly = 1,
  OnlineOnly = 2,
  PlayerCount = 3,
 ...
 * these match your value.
 */
export const enum FireteamFinderOptionAvailability {
  None = 0,
...
export const enum FireteamFinderOptionVisibility {
  Always = 0,
...
export const enum FireteamFinderOptionControlType {
  None = 0,
  ValueCollection = 1,
  RadioButton = 2
}
...
export const enum FireteamFinderOptionSearchFilterType {
  None = 0,
  All = 1,
  Any = 2,
  InRangeInclusive = 3,
...
export const enum FireteamFinderOptionDisplayFormat {
  Text = 0,
  Integer = 1,
  Bool = 2,
  FormatString = 3
...
export const enum FireteamFinderOptionValueProviderType {
  None = 0,
  Values = 1,
  PlayerCount = 2,
...
export interface DestinyFireteamFinderOptionValueDefinition {
   ...
   * these match your value.
   */
  readonly flags: FireteamFinderOptionValueFlags;
}
 ...
 * these match your value.
 */
export const enum FireteamFinderOptionValueFlags {
  None = 0,
...
export interface DestinyFireteamFinderLabelDefinition {
  readonly displayProperties: DestinyDisplayPropertiesDefinition;
  readonly descendingSortPriority: number;
  /** Mapped to DestinyFireteamFinderLabelGroupDefinition in the manifest. */
  readonly groupHash: number;
  readonly allowInFields: FireteamFinderLabelFieldType;
  /**
   * The unique identifier for this entity. Guaranteed to be unique for the type of
   * entity, but not globally.
   *
...
export const enum FireteamFinderLabelFieldType {
  Title = 0,
  Label = 1
}
...
export const enum DestinyActivityTreeType {
  FireteamFinder = 0,
  Curator = 1,
  EventHome = 2,
  SeasonHome = 3,
...
export const enum DestinyActivityTreeChildSortMode {
  Investment = 0,
  FocusFirst = 1,
...
export interface DestinyInventoryItemConstantsDefinition {
  ...
  readonly watermarkDropShadowPath: string;
  /** Reverse drop shadow for crafted icon identifier */
  readonly craftedBackgroundPath: string;
  /** Teal flag for featured item watermarks */
  readonly featuredItemFlagPath: string;
  /** Gold masterwork glow for non-Exotic items */
  readonly masterworkOverlayPath: string;
  /** Gold masterwork glow for Exotic items */
  readonly masterworkExoticOverlayPath: string;
  /** Gold masterwork glow for non-Exotic Items, with a gold border */
  readonly masterworkBorderedOverlayPath: string;
  /** Gold masterwork glow for Exotic items, with a gold border */
  readonly masterworkExoticBorderedOverlayPath: string;
  /** Crafted weapon overlay path */
  readonly craftedOverlayPath: string;
  /** Enhanced item overlay */
  readonly enhancedItemOverlayPath: string;
  /**
   * Layer between item and color background to denote holofoil status, introduced in
   * v736
   */
  readonly holofoilBackgroundOverlayPath: string;
  /**
   * Layer between item and color background to denote holofoil status, introduced in
   * v900
   */
  readonly holofoil900BackgroundOverlayPath: string;
  /**
   * Layer between item and color background to denote holofoil status, introduced in
   * v900, animated
   */
  readonly holofoil900AnimatedBackgroundOverlayPath: string;
  /** Layer between item and color background to denote universal ornament status */
  readonly universalOrnamentBackgroundOverlayPath: string;
  /**
   * Layer between a legendary item and its color background to denote universal
   * ornament status
   */
  readonly universalOrnamentLegendaryBackgroundOverlayPath: string;
  /**
   * Layer between an exotic item and its color background to denote universal
   * ornament status
   */
  readonly universalOrnamentExoticBackgroundOverlayPath: string;
  /**
   * The unique identifier for this entity. Guaranteed to be unique for the type of
   * entity, but not globally.
   *
