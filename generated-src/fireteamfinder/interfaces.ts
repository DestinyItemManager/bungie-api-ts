...
export const enum DestinyFireteamFinderApplicationType {
  Unknown = 0,
  Creator = 1,
  Search = 2,
  Invite = 3,
...
export const enum DestinyFireteamFinderApplicationState {
  Unknown = 0,
...
export const enum DestinyFireteamFinderLobbyPrivacyScope {
  Unknown = 0,
  Open = 1,
  Applications = 2,
  Clan = 3,
...
export const enum DestinyFireteamFinderLobbyState {
  Unknown = 0,
  Inactive = 1,
  Active = 2,
  Expired = 3,
...
export const enum DestinyFireteamFinderPlayerReadinessState {
  Unknown = 0,
  Reserved = 1,
  Disconnected = 2,
  InLobbyUnready = 3,
...
export const enum DestinyFireteamFinderOfferState {
  Unknown = 0,
  Pending = 1,
  Accepted = 2,
  Rejected = 3,
...
export const enum DestinyFireteamFinderListingFilterRangeType {
  Unknown = 0,
  All = 1,
  Any = 2,
  InRangeInclusive = 3,
...
export const enum DestinyFireteamFinderListingFilterMatchType {
  Unknown = 0,
  MustNot = 1,
  Should = 2,
  Filter = 3
